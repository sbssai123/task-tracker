defmodule TaskTrackerWeb.TaskControllerTest do
  ...
  @create_attrs %{completed: true, desc: "some desc", duration: ~T[14:00:00.000000], title: "some title"}
  @update_attrs %{completed: false, desc: "some updated desc", duration: ~T[15:01:01.000000], title: "some updated title"}
